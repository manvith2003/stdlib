...
*
* @example
* double y = stdlib_base_normal_entropy( 5.0, 3.0 );
* // returns ~2.518
*
* @example
* double y = stdlib_base_normal_entropy( NAN, 1.0 );
* // returns NaN
*
* @example
* double y = stdlib_base_normal_entropy( 0.0, NAN );
* // returns NaN
*
* @example
* double y = stdlib_base_normal_entropy( 0.0, 0.0 );
* // returns NaN
*/
double stdlib_base_dists_normal_entropy( const double mu, const double sigma ) {
	...
	return 0.5 * stdlib_base_log( STDLIB_CONSTANT_FLOAT64_TWO_PI * STDLIB_CONSTANT_FLOAT64_E * sigma * sigma, STDLIB_CONSTANT_FLOAT64_E );
}
